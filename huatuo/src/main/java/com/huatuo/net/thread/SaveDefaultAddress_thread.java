...
/** 获取兑换券列表 */
public class SaveDefaultAddress_thread implements Runnable {
	...
	public SaveDefaultAddress_thread(Context mContext, Handler mHandler,HashMap<String, String> injosnMap) {
	...
	public void run() {
		...
		CommonUtil.log("获取更新地址上传参数：injosnMap---------------->"+injsonMap);

			HttpAgent httpAgent = new HttpAgent("user/updateAddress", injsonMap, mContext);
