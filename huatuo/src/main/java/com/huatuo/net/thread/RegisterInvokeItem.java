...
public class RegisterInvokeItem implements Runnable {
	private Handler mHandler;
	private Context mContext;
	private String mobileNo, identifyingCode, password;

	public RegisterInvokeItem(Handler mHandler, Context mContext, String mobileNo, String identifyingCode, String password) {
	...
	public void run() {
		try {
			...
			HttpAgent httpAgent = new HttpAgent("user_Register", registerJsonObject, mContext);
