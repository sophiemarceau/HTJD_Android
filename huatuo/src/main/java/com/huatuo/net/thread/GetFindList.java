...
/** 获取订单列表 */
public class GetFindList implements Runnable {
	...
	public GetFindList(Context mContext, Handler mHandler, HashMap<String, String> map) {
	...
	public void run() {
		try {
			CommonUtil.log("获取发现列表上传参数：map：" + map);
			HttpAgent httpAgent = new HttpAgent("discover/list", map, mContext);
