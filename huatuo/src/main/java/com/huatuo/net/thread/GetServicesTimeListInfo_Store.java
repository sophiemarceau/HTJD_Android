 ...
 * 
 */
public class GetServicesTimeListInfo_Store implements Runnable {
	 ...
	 *            项目ID
	 * */
	public GetServicesTimeListInfo_Store(Context mContext, Handler mHandler, HashMap<String, String> inJson) {
	...
	public void run() {
		try {
			...
			HttpAgent httpAgent = new HttpAgent("publicorder/getServiceTime", inJsonMap,
					mContext);
