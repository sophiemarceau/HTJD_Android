...
public class CancelSpikeOrder implements Runnable {
	...
	public CancelSpikeOrder(Context mContext, Handler mHandler, HashMap<String, String> injosnMap) {
	...
	public void run() {
		try {
			// Log.e("获取取消订单上传参数：injosnMap",
			// "injosnMap---------------->"+injsonMap);
			HttpAgent httpAgent = new HttpAgent("spikeorder/cancelOrder", injsonMap, mContext);
