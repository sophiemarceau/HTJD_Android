...
/** 获取兑换券列表 */
public class CommitOrder_Thread implements Runnable {
	...
	public CommitOrder_Thread(Context mContext, Handler mHandler,HashMap<String, String> injosnMap) {
	...
	public void run() {
		try {
			...
			CommonUtil.logE("-------------上门提交订单上传参数:injosnMap---------------->"+injsonMap);

			HttpAgent httpAgent = new HttpAgent("order/genServiceOrder", injsonMap, mContext);
