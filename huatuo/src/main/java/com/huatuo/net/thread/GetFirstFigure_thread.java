...
/** 获取兑换券列表 */
public class GetFirstFigure_thread implements Runnable {
	...
	public GetFirstFigure_thread(Context mContext, Handler mHandler,HashMap<String, String> injosnMap) {
	...
	public void run() {
		try {
			...
			CommonUtil.log("获取首图提交 上传参数：injosnMap--------------->"+injsonMap);

			HttpAgent httpAgent = new HttpAgent("prop/firstFigure", injsonMap, mContext);
