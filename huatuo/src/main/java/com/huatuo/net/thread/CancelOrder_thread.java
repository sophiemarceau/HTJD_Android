...
/** 获取兑换券列表 */
public class CancelOrder_thread implements Runnable {
	...
	public CancelOrder_thread(Context mContext, Handler mHandler,HashMap<String, String> injosnMap) {
...
//			Log.e("获取取消订单上传参数：injosnMap", "injosnMap---------------->"+injsonMap);

			HttpAgent httpAgent = new HttpAgent("order/cancelOrder", injsonMap, mContext);
