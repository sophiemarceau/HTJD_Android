...
/** 获取订单列表 */
public class AddCollect implements Runnable {
	...
	public AddCollect(Context mContext, Handler mHandler, HashMap<String, String> map) {
	...
	public void run() {
		try {
			...
			HttpAgent httpAgent = new HttpAgent("collect/addCollect",
					map, mContext);
