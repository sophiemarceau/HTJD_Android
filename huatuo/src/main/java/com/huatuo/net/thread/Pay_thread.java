...
/** 获取兑换券列表 */
public class Pay_thread implements Runnable {
	...
	public Pay_thread(Context mContext, Handler mHandler,HashMap<String, String> injosnMap) {
	...
	public void run() {
		try {
			...
			CommonUtil.log("获取支付提交 上传参数：injosnMap--------------->"+injsonMap);

			HttpAgent httpAgent = new HttpAgent("pay/orderPay", injsonMap, mContext);
