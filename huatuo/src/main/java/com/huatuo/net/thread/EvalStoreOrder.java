...
public class EvalStoreOrder implements Runnable {
	...
	public EvalStoreOrder(Context mContext, Handler mHandler, String orderID,
			String skillScore, String projectScore, String storeScore,
			String remark, String tags) {
	...
	public void run() {
		try {
			...
			HttpAgent httpAgent = new HttpAgent("storeorder/evalStoreOrder",
