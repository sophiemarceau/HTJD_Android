...
/** 添加兑换券 */
public class AddCoupon implements Runnable {
	...
	public AddCoupon(Context mContext, Handler mHandler, String couponID) {
	...
	public void run() {
		try {
			...
			inJsonObject.put("couponID", couponID);
			CommonUtil.logE(inJsonObject + "");
			HttpAgent httpAgent = new HttpAgent("market/addCoupon", inJsonObject, mContext);
