...
/** 获取兑换券列表 */
public class CommitOrder_Thread_StoreQuickPay implements Runnable {
	...
	public CommitOrder_Thread_StoreQuickPay(Context mContext, Handler mHandler,HashMap<String, String> injosnMap) {
	...
	public void run() {
		try {
			...
			CommonUtil.logE("快捷支付提交订单上传参数：injosnMap---------------->"+injsonMap);
			HttpAgent httpAgent = new HttpAgent("quickorder/genQuickOrder", injsonMap, mContext);
