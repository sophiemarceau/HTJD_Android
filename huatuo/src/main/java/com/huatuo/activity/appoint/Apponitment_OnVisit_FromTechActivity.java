 ...
 * 
 */
public class Apponitment_OnVisit_FromTechActivity extends BaseActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_appointment_visit_tech);
		mContext = this;
		initWidget();
		initOnClickListener();
		initHandler();
	...
	private void GetDataFromServiceObj() {
		...
		CommonUtil.log("上门根据项目--appointServType:" + appointServType);// 1 到店，
																		// 2上门，3
																		// 自营的上门
		...
		String maxPrice = service_jsonObj.optString("maxPrice", "");// 自营
		gradePrice = minPrice;
		...
		sex = service_jsonObj.optString("gender", "");
		...
		CommonUtil.log("上门根据项目--接收到的技师：sex:" + sex);
...
//				Toast_Util.showToast(this, "支付成功");
	...
	public void onClick(View v) {
		...
		case R.id.layout_selectDaijinquan:// 选择代金券
			UmengEventUtil.door_tichniciandetail_projectdetail_placeorder_coupon(mContext);
			// 获取优惠券
	...
	private String serviceType = "";// 查询技师 服务类型 N 2 M 1 到店， 2上门
