 ...
 * 
 */
public class Apponitment_OnStore_FromProjectActivity extends BaseActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_appointment_store_pro);
		mContext = this;
		initWidget();
		initOnClickListener();
		initHandler();
	...
	class Handler_getUserInfo extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			// 获取完默认地址后 ---接受上个界面传过来的值
			getJsonObject_serDetail();// 从服务详情页面/技师详情页面 接受传过来的 值：
	...
	private void canSelectTechcial(boolean flag) {
		if (flag) {
			layout_selectJishi.setVisibility(View.VISIBLE);
			line_ixuanzejishi.setVisibility(View.VISIBLE);
		} else {
			layout_selectJishi.setVisibility(View.GONE);
			line_ixuanzejishi.setVisibility(View.GONE);
		}
	}
	...
	private void countFee() {
		...
		tv_countFee
				.setText("=￥" + NumFormatUtil.saveTwoPointOfDouble(countFee));
	...
	private void initWidget() {
		...
		line_ixuanzejishi = (View) findViewById(R.id.line_ixuanzejishi);
	...
	private View line_ixuanzejishi;
	...
	private String serviceType = "1";// 1 到店， 2上门
	// 备注
