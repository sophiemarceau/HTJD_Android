...
public class CustomDialog extends Dialog {  
    ...
    public static class Builder {  
        ...
        public CustomDialog create() {  
            ...
            final CustomDialog dialog = new CustomDialog(context,R.style.my_dialog);  
            View layout = inflater.inflate(R.layout.alertdialog_two_btn, null);  
...
//                    LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));  
            ...
            if (negativeButtonText != null) {  
                ((TextView) layout.findViewById(R.id.pc_cancel))  
                ...
                // if no confirm button just set the visibility to GONE  
                layout.findViewById(R.id.pc_cancel).setVisibility(  
                        View.GONE);  
            }  
