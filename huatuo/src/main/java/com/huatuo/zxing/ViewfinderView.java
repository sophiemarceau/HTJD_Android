...
//					 paint);
			...
			canvas.drawBitmap(((BitmapDrawable) (getResources().getDrawable(R.drawable.creat_line))).getBitmap(), null, lineRect, paint);
...
//			 paint.setTypeface(Typeface.create("System", Typeface.BOLD));
			 int textLen = (int) paint.measureText(getResources().getString(R.string.scan_text));
			 float x = (width- textLen)/2;
			 
			 canvas.drawText(getResources().getString(R.string.scan_text),
			 x, (float) (frame.top -(float)TEXT_PADDING_TOP
			 *density), paint);
