...
public class Select_Technician_ListViewAdapter extends BaseAdapter {
	...
	public Select_Technician_ListViewAdapter(Activity mContext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String serviceCount = jsonObject.optString("orderCount", "0");
		String score = jsonObject.optString("score", "0");
		...
		if (("0").equals(isSelfOwned)) {
			...
			holder.tv_tech_from.setText("华佗驾到");
		}
		convertView.setOnClickListener(new AppointTechOnClickListener(position,
				type_appoint));
	...
	static class ViewHolder {
		...
		TextView tv_isAppoint, tv_technicianName, tv_orderNumber, tv_pingfen,
	...
	class AppointTechOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case type_appoint:
				...
				intent2.putExtra("TECH", jsonObject.toString());
				mContext.setResult(Activity.RESULT_OK, intent2);
				mContext.finish();
				break;
			}
