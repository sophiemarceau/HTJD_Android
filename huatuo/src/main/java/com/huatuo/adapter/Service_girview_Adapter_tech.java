...
public class Service_girview_Adapter_tech extends BaseAdapter {
	 ...
	 * @param context
	 */
	public Service_girview_Adapter_tech(Activity context) {
		mContext = context;
	...
	static class ViewHolder {
		...
		TextView tv_from_store, tv_fuwuName, tv_jiage, tv_price2, tv_Oldjiage, tv_pingfen;
	}
	...
	class MyOnItemOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			UmengEventUtil.door_tichniciandetail_projectdetail(mContext);
			JSONObject jsonObject = arrayList.get(position);
