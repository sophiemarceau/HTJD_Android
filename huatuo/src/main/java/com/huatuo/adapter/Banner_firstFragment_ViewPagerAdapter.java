...
public class Banner_firstFragment_ViewPagerAdapter extends PagerAdapter {
	private Context mContext;
	private LayoutInflater inflater;
	private ArrayList<JSONObject> viewList;

	public Banner_firstFragment_ViewPagerAdapter(Context mContext) {
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		...
		CommonUtil.log("instantiateItem-----------------position:" + position);
			...
			ImageLoader.getInstance().displayImage(
					jsonObject.optString("url", ""), imageView,
					ImageLoader_DisplayImageOptions.getInstance().setDefaultImageBannerImg(),
