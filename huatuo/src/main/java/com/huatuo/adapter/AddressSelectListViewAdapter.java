...
public class AddressSelectListViewAdapter extends BaseAdapter {
	...
	public AddressSelectListViewAdapter(Context mContext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.rl_bootom = (RelativeLayout) convertView
					.findViewById(R.id.rl_bootom);
//			holder.rl_bootom.setVisibility(View.GONE);
		...
		if ("1".equals(isDefault)) {
			...
			holder.tv_default.setCompoundDrawablesWithIntrinsicBounds(mContext
					.getResources().getDrawable(R.drawable.icon_address_def),
					null, null, null);
			holder.tv_default.setText("默认地址");
			holder.tv_default.setTextColor(mContext.getResources().getColor(
					R.color.c4));

		} else {
			holder.tv_default.setCompoundDrawablesWithIntrinsicBounds(mContext
					.getResources().getDrawable(R.drawable.icon_address_nodef),
					null, null, null);
			...
			holder.tv_default.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					injosnMap.put("addressID", jsonObject.optString("ID", ""));
					injosnMap.put("userName",
							jsonObject.optString("userName", ""));
					injosnMap.put("sex", jsonObject.optString("sex", ""));
					injosnMap.put("mobile", jsonObject.optString("mobile", ""));
