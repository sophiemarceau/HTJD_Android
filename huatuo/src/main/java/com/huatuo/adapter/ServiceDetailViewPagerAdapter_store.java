...
public class ServiceDetailViewPagerAdapter_store extends PagerAdapter {
	private Context mContext;
	private LayoutInflater inflater;
	private ArrayList<JSONObject> viewList;

	public ServiceDetailViewPagerAdapter_store(Context mContext) {
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		...
		try {
			...
			String imageUrl = jsonObject.optString("servImg", "");
