...
public class ServiceDetailViewPagerAdapter extends PagerAdapter {
	private Context mContext;
	private LayoutInflater inflater;
	private ArrayList<JSONObject> viewList;

	public ServiceDetailViewPagerAdapter(Context mContext) {
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		...
		try {
			...
			String imageUrl = jsonObject.optString("promotionsImage", "");
