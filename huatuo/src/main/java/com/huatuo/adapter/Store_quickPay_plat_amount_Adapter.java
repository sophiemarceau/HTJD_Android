...
public class Store_quickPay_plat_amount_Adapter extends BaseAdapter {
	 ...
	 *            // item标题数组
	 */
	public Store_quickPay_plat_amount_Adapter(Context context,List<JSONObject> arrayList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.store_quick_pay_item, null);
			holder = new ViewHolder();
			holder.tv_privilege = (TextView) convertView.findViewById(R.id.tv_privilege);
			holder.iv_privilege = (ImageView) convertView.findViewById(R.id.iv_privilege);
			holder.view_privilege_line = (View) convertView.findViewById(R.id.view_privilege_line);
